...
async function init() {
  ...
  data = data.data;
  let third = document.querySelector(".third") as HTMLDivElement;
...
async function initannouncement() {
  ...
  let anfirst = document.querySelector(".anfirst") as HTMLDivElement;
...
async function initnotification() {
  ...
  let antt = document.querySelector(".noti") as HTMLDivElement;
...
function toggle() {
  let ele = document.querySelector(".forsm") as HTMLDivElement;
  let anou = document.querySelector(".announcement") as HTMLDivElement;
  let noti = document.querySelector(".notifications") as HTMLDivElement;
...
function toggleanouncement() {
  let ele = document.querySelector(".announcement") as HTMLDivElement;
  let noti = document.querySelector(".notifications") as HTMLDivElement;
  let forsm = document.querySelector(".forsm") as HTMLDivElement;
...
function shownotification() {
  let ele = document.querySelector(".notifications") as HTMLDivElement;
  let anou = document.querySelector(".announcement") as HTMLDivElement;
  let forsm = document.querySelector(".forsm") as HTMLDivElement;
...
function ccchange(classname: string) {
  let ele = document.querySelector("." + classname) as HTMLDivElement;
